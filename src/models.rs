...
impl YoloModel {
    ...
    fn decode_head(data: &[f32], w: usize, h: usize, stride: usize, conf_threshold: f32, detections: &mut Vec<Detection>) {
        for y in 0..h {
            for x in 0..w {
                let offset = y * w + x;
    ...
    fn decode_concatenated(data: &[f32], channels: usize, anchors: usize, conf_threshold: f32, detections: &mut Vec<Detection>) {
        for i in 0..anchors {
